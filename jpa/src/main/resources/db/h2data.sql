...
INSERT INTO posts (post_id, user_id, post_title, post_name, post_link, post_date, post_modified, post_type, display_type, is_published, post_content, post_source, post_image, click_count, likes_count, value_rating, version) VALUES (4, 3, 'Content Negotiation using Spring MVC', 'content-negotiation-using-spring-mvc', 'https://spring.io/blog/2013/05/11/content-negotiation-using-spring-mvc', '2016-06-06 15:32:28', '2016-06-06 15:32:28', 'LINK', 'LINK_SUMMARY', 1, '<p>There are two ways to generate output using Spring MVC...</p>', 'spring.io', '/images/posts/spring.png', 0, 0, 0, 0);
