...
public class GeneralController {
	...
	@RequestMapping(value = { "{path:(?!webjars|static|h2-console).*$}",
			"{path:(?!webjars|static|h2-console).*$}/**" }, headers = "Accept=text/html")
	public void unknown() {
	...
	public @ResponseBody String updateBadges(@RequestBody List<String> badgeboys) {
		if (badgeboys != null) {
	...
	public @ResponseBody List<SelectOptionDTO> getBadges() {
