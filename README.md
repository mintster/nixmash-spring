...
- **[v0.3.2 -- Initial Posts Feature Release (In Progress)](#v032----initial-posts-feature-release-in-progress)** : *Jsoup Annotations Framework, Generic Type as Beans*
...
##v0.3.2 -- Initial Posts Feature Release (In Progress)##
