...
public class SolrLocationTests extends SolrContext {
	...
	public void testFindByLocationWithin() {
		List<Product> found = repo.findByLocationWithin(new Point(22.15, -90.85), new Distance(5, Metrics.MILES));
		locationAsserts(found);
	}

	@Test
	public void testFindByQueryNear() {
		List<Product> found = repo.findByLocationSomewhereNear(new Point(22.15, -90.85),
				new Distance(5, Metrics.MILES));
		locationAsserts(found);
	}
	...
	public void testFindByNear() {
		List<Product> found = repo.findByLocationNear(new Point(22.15, -90.85), new Distance(5, Metrics.MILES));
		locationAsserts(found);
	}
